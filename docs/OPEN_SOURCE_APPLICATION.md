...
| 2026-08-26 | Actions finalization and restart recovery | PRs #16 and #17 passed GitHub Actions and merged; local regression passed 156 tests with pre-download tamper rejection, durable completed runs, and interrupted-run finalization without redispatch | [PR #16](https://github.com/sheryloe/pocketforge-relay/pull/16), [PR #17](https://github.com/sheryloe/pocketforge-relay/pull/17), [`VERIFICATION.md`](VERIFICATION.md) |
