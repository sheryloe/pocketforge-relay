...
export function relayCapabilities({ actionsEnabled = false, deviceEnabled = false, agentEnabled = false } = {}) {
  return Object.freeze({
    ...
    adapters: Object.freeze([
      ...
      adapterDescriptor({ id: 'ai-agent', kind: 'agent', enabled: agentEnabled, capabilities: ['evidence-preview', 'explicit-consent', 'structured-proposal'] }),
    ]),
  });
}
